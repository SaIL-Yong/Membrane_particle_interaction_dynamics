...
axis equal;
axis([-1.40 1.40 -1.40 1.40 -1.40 1.40]);  % your fixed axis limits
ax.XColor = 'none';
ax.YColor = 'none';
ax.ZColor = 'none';
...
for n = 0:dumpfrequency:maxiteration
    ...
    quiverHandles = [
        ...
        quiver3(center_of_mass(1), center_of_mass(2), center_of_mass(3), ...
                ...
                'LineWidth',2, 'MaxHeadSize',0.5, 'Color','g');
        quiver3(center_of_mass(1), center_of_mass(2), center_of_mass(3), ...
    ...
    pp = patch('Faces', tri, 'Vertices', [x,y,z], ...
               ...
               'FaceAlpha',0.2, 'EdgeColor','k','EdgeAlpha',0.2);

    pp1 = patch('Faces', tri1, 'Vertices', [x1,y1,z1], ...
                'FaceColor',"r", 'FaceLighting','gouraud', ...
                'FaceAlpha',0.5, 'EdgeColor','k','EdgeAlpha',0.5);
