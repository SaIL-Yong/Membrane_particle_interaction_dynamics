...
class Energy {
 public:
  ...
  void compute_bendingenergy_force(Eigen::MatrixXd V, Eigen::MatrixXi F, double Kb, Eigen::MatrixXd& Force_Bending, double& bending_energy);
  void compute_areaenergy_force(Eigen::MatrixXd V, Eigen::MatrixXi F, double Ka, double area_target, Eigen::MatrixXd& Force_Area, double& area_energy);
  void compute_volumeenergy_force(Eigen::MatrixXd V, Eigen::MatrixXi F, double Kv, double reduced_volume, Eigen::MatrixXd& Force_Volume, double& volume_energy);
  ...
  void compute_adhesion_energy_force(Eigen::MatrixXd V,Eigen::MatrixXi F, double X, double Y, double Z,
                                     ...
                                     Eigen::MatrixXd& Force_Adhesion, double& EnergyAdhesion, double& E_bias);

  double area_current, volume_current;
 ...
 private:
  ...
  Eigen::VectorXd EB;
  Eigen::MatrixXd H_X_N;
  Eigen::VectorXd abc;
  Eigen::VectorXd sign_of_H;
